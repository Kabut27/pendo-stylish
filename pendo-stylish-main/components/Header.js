    ...
    <>
      ...
      <header className="site-header">
        <div className="header-icons container">
          <label htmlFor="mmenu-toggle" className="icon-btn mmenu-open-btn" aria-label="Fungua menu">
      ...
      {/* Backdrop nyeusi-nyeusi nyuma ya drawer - kubonyeza sehemu hii
          kunafunga menu (label hiyo hiyo inayotumika kwa X na hamburger,
          bado CSS pekee, hakuna JS inayohitajika). */}
      <label
        htmlFor="mmenu-toggle"
      ...
      {/* .mmenu-overlay pia iko NJE ya <header>, kama ndugu yake, ili
          ...
          dhidi ya kisanduku kidogo cha .site-header. Sasa ni "drawer"
          inayotelezea kutoka kushoto (kama .dash-sidebar ya dashibodi),
          si tena overlay ya skrini nzima. */}
